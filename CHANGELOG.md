...
- Replaced edge/host toggle button text with colored Dashicons (`plus` in green to add, `no` in red to clear) followed by Edge/Host labels, with accessible tooltips for each action.
